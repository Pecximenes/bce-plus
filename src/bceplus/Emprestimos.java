...
public class Emprestimos extends javax.swing.JFrame {
    ...
    private void botaoFinalizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoFinalizarActionPerformed
        ...
        int dias = this.usuario.isProfessor() ? 30 : 15;
        Double multaa = this.usuario.isProfessor() ? 0.80 : 0.50;
        this.devolucao = this.dataAtual.plusDays(dias);
        dataDevolucao.setText(this.devolucao.toString());
        ...
        if (bibliotecario != null) {
            ...
            Emprestimo emprestimo = new Emprestimo(usuario, bibliotecario,livros, this.devolucao, multaa);
            ...
            Emprestimo emprestimo = new Emprestimo(usuario,livros, this.devolucao, multaa);
            BancoDeDados banquinho = BancoDeDados.getInstance();
            banquinho.addEmprestimo(emprestimo);
            JOptionPane.showMessageDialog(this, "Empréstimo realizado com sucesso!", "Sucesso", JOptionPane.INFORMATION_MESSAGE);
            this.dispose();
